...
extension LibraryService {
    func downloadData() -> [LibViewData]{
        var libList = [LibViewData]()
//        var flag = true
                    ...
                    for  value in items {
                        if let v = value as? [String:Any]{
                            if let content = v["Item"] as? [String: Any]{
                                let libArray = LibViewData(title: content["title"] as! String, author: content["author"] as! String, publisherName: content["publisherName"] as! String, samllImageUrl: content["smallImageUrl"] as! String, largeImageUrl: content["largeImageUrl"] as! String, itemCaption: content["itemCaption"] as! String)
